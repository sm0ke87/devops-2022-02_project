...
Terrafrom разворачивает 2 инстанса: \
    1.При разворачивании первого инстанса отрабатывается Provisioner c Ansible и проивзодит установку Docker-compose c Gitlab \
    2.Второй инстанс будет исполнять роль раннера, который мы настроем вручную для сборки приложения
План:
